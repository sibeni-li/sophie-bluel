...
const response = await fetch("https://sb01.sibeni.dev/api/works/");
const works = await response.json();

const respbis = await fetch("https://sb01.sibeni.dev/api/categories/");
...
async function respReload() {
    const responseReload = await fetch("https://sb01.sibeni.dev/api/works/");
...
function deleteWorks(){
    ...
    deleteElement.forEach(element => {
        element.addEventListener("click", async function (e) {
            ...
            fetch("https://sb01.sibeni.dev/api/works/" + workId, {
                method: "DELETE",
                headers: {
                    "accept": "*/*",
...
form.addEventListener("submit", async function (e) {
    ...
    try{
        const fetchAdd = await fetch("https://sb01.sibeni.dev/api/works/", {
            method: "POST",
            headers: {
